...
const SignUp = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.password) {
      ...
      newErrors.password = 'Password must include letters and at least one number or special character';
      isValid = false;
    }
        ...
        <Card>
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-4">
              ...
              <div className="text-sm text-eigengram-muted">
                Password must be at least 8 characters and include both letters and numbers or special characters.
              </div>
            </CardContent>
