        ...
        <CardContent className="pt-6">
          <div className="prose max-w-none">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-sm text-VitalCarePlatform-muted mb-2">
                Access this AI model via its secure endpoint:
              </p>
              <div className="bg-VitalCarePlatform-muted/20 p-3 rounded flex items-center justify-between">
                <code className="text-sm truncate">{service.awsModelUrl}</code>
                <Button size="sm" variant="ghost">
                  <ExternalLink size={14} />
                </Button>
              </div>
              <p className="text-xs text-VitalCarePlatform-muted mt-2">
            ...
            {subscriptionStatus === "ACTIVE" ? (
              <div className="bg-green-50 border border-green-200 rounded-md p-4">
                <p className="text-green-800 text-sm font-medium">
                  You're subscribed to this service. You can access the model
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                <p className="text-yellow-800 text-sm font-medium">
                  Your subscription request is pending approval. You'll be
